            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                <div className="mx-auto mb-9 text-center">
                  <div className="dark:hidden justify-center">
                    <svg
                    ...
                    >
                      ...
                      <g mask="url(#mask0_1028_3014)">
                        ...
                        />
                        <g opacity="0.8" filter="url(#filter0_f_1028_3014)">
                          <circle
                            cx="233.543"
                            cy="48.2645"
                            r="28.2059"
                      ...
                      <defs>
                        ...
                        <linearGradient
                          ...
                          gradientUnits="userSpaceOnUse"
                        >
                          <stop stopColor="#93A7F9" stopOpacity="0.26" />
                          <stop offset="1" stopColor="#4E70FF" />
                        </linearGradient>
                        <linearGradient
                ...
                <Link
                  href="/"
                  className="rounded-sm bg-primary py-4 px-9 text-base font-medium text-white
                             shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark"
                >
                  Back to Homepage
                </Link>
              </div>
